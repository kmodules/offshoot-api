...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProcessSchedulingSettings) DeepCopyInto(out *ProcessSchedulingSettings) {
	*out = *in
	if in.Class != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProcessSchedulingSettings.
func (in *ProcessSchedulingSettings) DeepCopy() *ProcessSchedulingSettings {
	if in == nil {
		return nil
	}
	out := new(ProcessSchedulingSettings)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RuntimeSettings) DeepCopyInto(out *RuntimeSettings) {
	*out = *in
	...
	if in.DiskCache != nil {
		in, out := &in.DiskCache, &out.DiskCache
		*out = new(CacheSettings)
		(*in).DeepCopyInto(*out)
	}
	if in.ProcessScheduling != nil {
		in, out := &in.ProcessScheduling, &out.ProcessScheduling
		*out = new(ProcessSchedulingSettings)
		(*in).DeepCopyInto(*out)
	}
	return
