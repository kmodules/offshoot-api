...
type PodRuntimeSettings struct {
	...
	// +optional
	PodLabels map[string]string `json:"podLabels,omitempty" protobuf:"bytes,1,rep,name=podLabels"`
	// PodAnnotations are the annotations that will be attached with the respective Pod
	// +optional
	PodAnnotations map[string]string `json:"podAnnotations,omitempty" protobuf:"bytes,2,rep,name=podAnnotations"`
	...
	// +optional
	ServiceAccountAnnotations map[string]string `json:"serviceAccountAnnotations,omitempty" protobuf:"bytes,5,rep,name=serviceAccountAnnotations"`
	// AutomountServiceAccountToken indicates whether a service account token should be automatically mounted.
	// +optional
	AutomountServiceAccountToken *bool `json:"automountServiceAccountToken,omitempty" protobuf:"varint,6,opt,name=automountServiceAccountToken"`
	...
	// +optional
	SecurityContext *core.PodSecurityContext `json:"securityContext,omitempty" protobuf:"bytes,8,opt,name=securityContext"`
	...
	// +optional
	ImagePullSecrets []core.LocalObjectReference `json:"imagePullSecrets,omitempty" protobuf:"bytes,9,rep,name=imagePullSecrets"`
	...
	// +optional
	Tolerations []core.Toleration `json:"tolerations,omitempty" protobuf:"bytes,12,rep,name=tolerations"`
	...
	// +optional
	ReadinessGates []core.PodReadinessGate `json:"readinessGates,omitempty" protobuf:"bytes,15,rep,name=readinessGates"`
	...
	// +optional
	RuntimeClassName *string `json:"runtimeClassName,omitempty" protobuf:"bytes,16,opt,name=runtimeClassName"`
	// EnableServiceLinks indicates whether information about services should be injected into pod's
	// environment variables, matching the syntax of Docker links.
	// Optional: Defaults to true.
	// +optional
	EnableServiceLinks *bool `json:"enableServiceLinks,omitempty" protobuf:"varint,17,opt,name=enableServiceLinks"`
	...
	TopologySpreadConstraints []core.TopologySpreadConstraint `json:"topologySpreadConstraints,omitempty" patchStrategy:"merge" patchMergeKey:"topologyKey" protobuf:"bytes,18,rep,name=topologySpreadConstraints"`
}
